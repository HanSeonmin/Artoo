    ...
    private fun setOnClickListener() {
        ...
        btn_join_next1.setOnClickListener {
            ...
            try {
                ...
                if (check == 1) {
                    val getDuplicationEmailResponse: Call<GetDuplicateEmailResponse> =
                        networkService.getDuplicateEmailResponse(input_email)
                    getDuplicationEmailResponse.enqueue(object : Callback<GetDuplicateEmailResponse> {
                        ...
                        override fun onResponse(
                            call: Call<GetDuplicateEmailResponse>,
                            response: Response<GetDuplicateEmailResponse>
                        ) {
