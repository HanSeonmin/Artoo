...
class ProductCraftFragment : Fragment() {

    var craftData = ArrayList<ProductOverviewData>()
    lateinit var productRecyclerViewAdapter: ProductRecyclerViewAdapter

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val view: View = inflater.inflate(R.layout.fragment_product_craft, container, false)
        return view
    }
